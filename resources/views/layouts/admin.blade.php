...
<head>
  ...
  tinymce.init(editor_config);
    ...
    <link rel="stylesheet" href="{{asset('css/admin/order_detail.css')}}">
   @yield('css')
        ...
        <div id="page-body" class="d-flex">
            <div id="sidebar" class="bg-white">
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link {{session('module_active')=='pages'?'active':''}}">
                    ...
                    <li class="nav-link {{session('module_active')=='posts'?'active':''}}"   >
                    ...
                    <li class="nav-link {{session('module_active')=='products'?'active':''}} ">
                    ...
                    <li class="nav-link  {{session('module_active')=='orders'?'active':''}}">
                    ...
                    <li class="nav-link  {{session('module_active')=='sliders'?'active':''}} ">
                    ...
                    <li class="nav-link {{session('module_active')=='users'?'active':''}}">
                    ...
                    <li class="nav-link {{session('module_active') == 'roles'?'active':''}}">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{url('admin/roles/permission')}}">Tạo dữ liệu permission</a></li>
                        </ul>
                    </li>
